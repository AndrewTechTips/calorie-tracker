...
export const en = {
  "tutorial": {
    ...
    "momentumBody": "Momentum builds as you log and stay near your calorie target. One quiet day barely moves it — nothing here ever resets to zero. The row is your last 7 days; today fills as you log. Everything below is grouped into tappable cards — tap any header to expand it.",
...
export const ro = {
  "tutorial": {
    ...
    "momentumBody": "Impulsul crește pe măsură ce înregistrezi și rămâi aproape de obiectivul caloric. O zi mai liniștită abia îl mișcă — nimic de aici nu revine la zero. Rândul arată ultimele 7 zile; ziua de azi se umple pe măsură ce înregistrezi. Tot ce e dedesubt e grupat în carduri pe care le poți atinge — apasă orice titlu pentru a-l extinde.",

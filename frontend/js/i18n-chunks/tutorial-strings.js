...
export const en = {
  "tutorial": {
    ...
    "momentumTitle": "Your momentum",
    "momentumBody": "Momentum builds as you log and stay near your calorie target. One quiet day barely moves it — nothing here ever resets to zero. The row is your last 7 days; today fills as you log. Below it, four tiles show your week at a glance — tap any one to open its full charts and history.",
    "workoutTitle": "Your workout diary",
    "workoutBody": "The Training tile shows your sessions this week. Open it, then tap Open Diary for the full-screen workout diary — start a session, browse past workouts on the calendar, and see your estimated calories burned.",
...
export const ro = {
  "tutorial": {
    ...
    "momentumTitle": "Impulsul tău",
    "momentumBody": "Impulsul crește pe măsură ce înregistrezi și rămâi aproape de obiectivul caloric. O zi mai liniștită abia îl mișcă — nimic de aici nu revine la zero. Rândul arată ultimele 7 zile; ziua de azi se umple pe măsură ce înregistrezi. Dedesubt, patru dale îți arată săptămâna dintr-o privire — apasă oricare ca să deschizi graficele și istoricul complet.",
    "workoutTitle": "Jurnalul tău de antrenament",
    "workoutBody": "Dala Antrenament arată sesiunile din această săptămână. Deschide-o, apoi apasă „Deschide jurnalul” pentru jurnalul de antrenament pe tot ecranul — începe o sesiune, răsfoiește antrenamentele anterioare în calendar și vezi caloriile estimate arse.",

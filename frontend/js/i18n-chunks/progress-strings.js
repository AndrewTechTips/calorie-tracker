...
export const en = {
  "progress": {
    ...
    "momentumTierFlying": "Flying",
    "momentumTierInGroove": "In a groove",
    "momentumTierRolling": "Rolling",
    "momentumTierFindingFeet": "Finding your feet",
    "momentumTierJustStarting": "Just starting",
    "momentumOnTrack": "{{on}} of {{total}} days on track",
    "momentumNoData": "Log a meal to get started",
    "momentumWeekAria": "This week: {{on}} days on track, {{off}} over target, {{none}} not logged. Today is {{todayPct}}% toward your calorie goal.",
    "momentumInsightZero": "Log a meal and some water today — that's all it takes to get your momentum moving.",
    "momentumInsightJustStarting": "A quiet stretch. One day on target gets your momentum moving again.",
    "momentumInsightFindingFeet": "You're building it back. Two days on target in a row and you're rolling.",
    "momentumInsightRolling": "Momentum's picking up. Keep logging and staying near your calorie target.",
    "momentumInsightInGroove": "Strong, steady week — you're close to your best.",
    "momentumInsightFlying": "You're flying. This is exactly what consistency looks like.",
    "bentoCalories": "Calories",
    "bentoMacros": "Macros",
    "bentoWeight": "Weight",
    "bentoTraining": "Training",
    "bentoCaloriesAria": "Open calorie details",
    "bentoMacrosAria": "Open macro details",
    "bentoWeightAria": "Open weight details",
    "bentoTrainingAria": "Open training details",
    "bentoCaloriesEmpty": "Log a meal to see your week",
    "bentoMacrosEmpty": "Log a meal to see your split",
    "bentoWeightEmpty": "Log a weigh-in to start",
    "bentoTrainingEmpty": "Log a workout to start",
    "bentoCalUnit": "/ {{target}} avg",
    "bentoTrainingWeek": "{{count}} this week",
    "bentoTrainingFocus": "Least trained: {{name}}",
    "bentoTrainingBalanced": "All areas covered",
    "detailInfoAria": "About this section",
    "sundayCheckinEyebrow": "Last week",
    "sundayCheckinDismiss": "Done",
    "pastWeeksLabel": "Past weeks",
    "weekHeadlineStrongest": "Your strongest week yet",
    "weekHeadlineOnTrack": "{{count}} on-track days",
    "weekHeadlineOnTrackOne": "One on-track day",
    "weekHeadlineSameAsLast": "Same as last week — {{count}} on-track days",
    "weekHeadlineQuiet": "A quieter week",
    "weekHeadlineFresh": "A fresh start",
    "weekNudgeStrong": "Carry that into the new week.",
    "weekNudgeBuilding": "Two on-track days to open strong.",
    "weekNudgeFresh": "Fresh week, clean slate — one good day gets it moving.",
    "pastWeekStripAria": "{{on}} days on track, {{off}} logged over target, {{none}} not logged",
    "pastWeekRowAria": "Week of {{range}}: {{headline}}, ended {{tier}}",
    "weightVerdictSteady": "Holding steady — this is maintenance",
    "weightVerdictDown": "Trending down, about {{rate}} kg/week",
    "weightVerdictUp": "Trending up, about {{rate}} kg/week"
  },
  "cardInfo": {
    "streak": {
      "title": "Your Streak",
...
export const ro = {
  "progress": {
    ...
    "momentumTierFlying": "În zbor",
    "momentumTierInGroove": "În ritm",
    "momentumTierRolling": "În mișcare",
    "momentumTierFindingFeet": "Îți găsești echilibrul",
    "momentumTierJustStarting": "Abia începi",
    "momentumOnTrack": "{{on}} din {{total}} zile în obiectiv",
    "momentumNoData": "Înregistrează o masă ca să începi",
    "momentumWeekAria": "Săptămâna asta: {{on}} zile în obiectiv, {{off}} peste obiectiv, {{none}} neînregistrate. Azi ești la {{todayPct}}% din obiectivul caloric.",
    "momentumInsightZero": "Înregistrează o masă și niște apă azi — atât e nevoie ca să-ți pornești impulsul.",
    "momentumInsightJustStarting": "O perioadă mai liniștită. O zi în obiectiv îți repornește impulsul.",
    "momentumInsightFindingFeet": "Îl reconstruiești. Două zile la rând în obiectiv și prinzi avânt.",
    "momentumInsightRolling": "Impulsul crește. Continuă să înregistrezi și să rămâi aproape de obiectivul caloric.",
    "momentumInsightInGroove": "Săptămână solidă și constantă — ești aproape de cel mai bun nivel al tău.",
    "momentumInsightFlying": "Zbori. Exact așa arată constanța.",
    "bentoCalories": "Calorii",
    "bentoMacros": "Macro",
    "bentoWeight": "Greutate",
    "bentoTraining": "Antrenament",
    "bentoCaloriesAria": "Deschide detaliile caloriilor",
    "bentoMacrosAria": "Deschide detaliile macro",
    "bentoWeightAria": "Deschide detaliile greutății",
    "bentoTrainingAria": "Deschide detaliile antrenamentului",
    "bentoCaloriesEmpty": "Înregistrează o masă ca să vezi săptămâna",
    "bentoMacrosEmpty": "Înregistrează o masă ca să vezi împărțirea",
    "bentoWeightEmpty": "Înregistrează o cântărire ca să începi",
    "bentoTrainingEmpty": "Înregistrează un antrenament ca să începi",
    "bentoCalUnit": "/ {{target}} medie",
    "bentoTrainingWeek": "{{count}} săptămâna asta",
    "bentoTrainingFocus": "Cel mai puțin: {{name}}",
    "bentoTrainingBalanced": "Toate zonele acoperite",
    "detailInfoAria": "Despre această secțiune",
    "sundayCheckinEyebrow": "Săptămâna trecută",
    "sundayCheckinDismiss": "Gata",
    "pastWeeksLabel": "Săptămâni anterioare",
    "weekHeadlineStrongest": "Cea mai bună săptămână de până acum",
    "weekHeadlineOnTrack": "{{count}} zile în obiectiv",
    "weekHeadlineOnTrackOne": "O zi în obiectiv",
    "weekHeadlineSameAsLast": "La fel ca săptămâna trecută — {{count}} zile în obiectiv",
    "weekHeadlineQuiet": "O săptămână mai liniștită",
    "weekHeadlineFresh": "Un nou început",
    "weekNudgeStrong": "Du asta mai departe în noua săptămână.",
    "weekNudgeBuilding": "Două zile în obiectiv ca să începi puternic.",
    "weekNudgeFresh": "Săptămână nouă, foaie curată — o zi bună o pune în mișcare.",
    "pastWeekStripAria": "{{on}} zile în obiectiv, {{off}} înregistrate peste obiectiv, {{none}} neînregistrate",
    "pastWeekRowAria": "Săptămâna {{range}}: {{headline}}, încheiată la {{tier}}",
    "weightVerdictSteady": "Se menține — asta e menținere",
    "weightVerdictDown": "În scădere, cam {{rate}} kg/săptămână",
    "weightVerdictUp": "În creștere, cam {{rate}} kg/săptămână"
  },
  "cardInfo": {
    "streak": {
      "title": "Seria Ta",

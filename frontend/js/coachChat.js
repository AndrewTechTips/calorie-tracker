...
import { openSheet, vibrate } from "./ui.js?v=20260819f";
import { onLanguageChange, t } from "./i18n.js?v=20260819f";
import { api } from "./api.js?v=20260819f";
import { QUESTIONS, computeInsight, fetchWeeklyRecap, waveOllie } from "./aiCoach.js?v=20260819f";
import { isVoiceInputSupported, toggleVoiceInput, stopVoiceInput } from "./scan.js?v=20260819f";

...
import { openSheet, vibrate } from "./ui.js?v=20260817h";
import { onLanguageChange, t } from "./i18n.js?v=20260817h";
import { api } from "./api.js?v=20260817h";
import { QUESTIONS, computeInsight, fetchWeeklyRecap, waveOllie } from "./aiCoach.js?v=20260817h";
import { isVoiceInputSupported, toggleVoiceInput, stopVoiceInput } from "./scan.js?v=20260817h";

...
import { openSheet, vibrate } from "./ui.js?v=20260814n";
import { onLanguageChange, t } from "./i18n.js?v=20260814n";
import { api } from "./api.js?v=20260814n";
import { QUESTIONS, computeInsight, fetchWeeklyRecap, waveOllie } from "./aiCoach.js?v=20260814n";
import { isVoiceInputSupported, toggleVoiceInput, stopVoiceInput } from "./scan.js?v=20260814n";

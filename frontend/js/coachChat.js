...
import { openSheet, vibrate } from "./ui.js?v=20260817e";
import { onLanguageChange, t } from "./i18n.js?v=20260817e";
import { api } from "./api.js?v=20260817e";
import { QUESTIONS, computeInsight, fetchWeeklyRecap, waveOllie } from "./aiCoach.js?v=20260817e";
import { isVoiceInputSupported, toggleVoiceInput, stopVoiceInput } from "./scan.js?v=20260817e";

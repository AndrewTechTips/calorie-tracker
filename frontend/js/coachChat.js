...
import { openSheet, vibrate } from "./ui.js?v=20260820m";
import { onLanguageChange, t } from "./i18n.js?v=20260820m";
import { api } from "./api.js?v=20260820m";
import { QUESTIONS, computeInsight, fetchWeeklyRecap, waveOllie } from "./aiCoach.js?v=20260820m";
import { isVoiceInputSupported, toggleVoiceInput, stopVoiceInput } from "./scan.js?v=20260820m";
import { initOllie3D, PetController } from "./ollie3d.js?v=20260820m";

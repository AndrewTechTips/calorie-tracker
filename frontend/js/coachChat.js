...
import { openSheet, vibrate } from "./ui.js?v=20260822s";
import { onLanguageChange, t } from "./i18n.js?v=20260822s";
import { api } from "./api.js?v=20260822s";
import { QUESTIONS, computeInsight, fetchWeeklyRecap, waveOllie } from "./aiCoach.js?v=20260822s";
import { isVoiceInputSupported, toggleVoiceInput, stopVoiceInput } from "./scan.js?v=20260822s";
import { initOllie3D, PetController } from "./ollie3d.js?v=20260822s";

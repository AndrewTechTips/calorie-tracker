...
import { openSheet, vibrate } from "./ui.js?v=20260821f";
import { onLanguageChange, t } from "./i18n.js?v=20260821f";
import { api } from "./api.js?v=20260821f";
import { QUESTIONS, computeInsight, fetchWeeklyRecap, waveOllie } from "./aiCoach.js?v=20260821f";
import { isVoiceInputSupported, toggleVoiceInput, stopVoiceInput } from "./scan.js?v=20260821f";
import { initOllie3D, PetController } from "./ollie3d.js?v=20260821f";

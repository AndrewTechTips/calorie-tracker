...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260818a";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260818a";
import { openProductResult } from "./scan.js?v=20260818a";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260818a";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260818a";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260818a";
import { translateMuscle } from "./exerciseI18n.js?v=20260818a";

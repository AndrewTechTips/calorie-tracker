...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260810r";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260810r";
import { openProductResult } from "./scan.js?v=20260810r";
import { openWorkoutSheet } from "./progress.js?v=20260810r";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260810r";

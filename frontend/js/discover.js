...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260810e";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260810e";
import { openProductResult } from "./scan.js?v=20260810e";
import { openWorkoutSheet } from "./progress.js?v=20260810e";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260810e";

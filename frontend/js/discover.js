...
import { api } from "./api.js?v=20260812q";
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260812q";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260812q";
import { openProductResult } from "./scan.js?v=20260812q";
import { openWorkoutSheet } from "./progress.js?v=20260812q";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260812q";

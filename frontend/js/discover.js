...
import { api } from "./api.js?v=20260811i";
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260811i";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260811i";
import { openProductResult } from "./scan.js?v=20260811i";
import { openWorkoutSheet } from "./progress.js?v=20260811i";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260811i";

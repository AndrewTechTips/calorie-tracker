...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260822j";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260822j";
import { openProductResult } from "./scan.js?v=20260822j";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260822j";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260822j";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260822j";
import { translateMuscle } from "./exerciseI18n.js?v=20260822j";

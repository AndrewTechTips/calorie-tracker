...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260813a";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260813a";
import { openProductResult } from "./scan.js?v=20260813a";
import { openWorkoutSheet } from "./progress.js?v=20260813a";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260813a";

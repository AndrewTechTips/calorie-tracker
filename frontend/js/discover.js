...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260822s";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260822s";
import { openProductResult } from "./scan.js?v=20260822s";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260822s";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260822s";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260822s";
import { translateMuscle } from "./exerciseI18n.js?v=20260822s";

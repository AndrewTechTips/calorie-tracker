...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260822t";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260822t";
import { openProductResult } from "./scan.js?v=20260822t";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260822t";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260822t";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260822t";
import { translateMuscle } from "./exerciseI18n.js?v=20260822t";

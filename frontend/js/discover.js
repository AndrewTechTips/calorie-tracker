...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260822u";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260822u";
import { openProductResult } from "./scan.js?v=20260822u";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260822u";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260822u";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260822u";
import { translateMuscle } from "./exerciseI18n.js?v=20260822u";

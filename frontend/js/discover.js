...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260820b";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260820b";
import { openProductResult } from "./scan.js?v=20260820b";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260820b";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260820b";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260820b";
import { translateMuscle } from "./exerciseI18n.js?v=20260820b";

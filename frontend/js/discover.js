...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260819g";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260819g";
import { openProductResult } from "./scan.js?v=20260819g";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260819g";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260819g";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260819g";
import { translateMuscle } from "./exerciseI18n.js?v=20260819g";

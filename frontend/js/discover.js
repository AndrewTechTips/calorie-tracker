...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260817j";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260817j";
import { openProductResult } from "./scan.js?v=20260817j";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260817j";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260817j";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260817j";
import { translateMuscle } from "./exerciseI18n.js?v=20260817j";

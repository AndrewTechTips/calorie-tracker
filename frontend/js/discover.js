...
import { api } from "./api.js?v=20260813c";
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260813c";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260813c";
import { openProductResult } from "./scan.js?v=20260813c";
import { openWorkoutSheet } from "./progress.js?v=20260813c";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260813c";

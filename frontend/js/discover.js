...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260818b";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260818b";
import { openProductResult } from "./scan.js?v=20260818b";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260818b";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260818b";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260818b";
import { translateMuscle } from "./exerciseI18n.js?v=20260818b";

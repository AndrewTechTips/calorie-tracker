...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260820f";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260820f";
import { openProductResult } from "./scan.js?v=20260820f";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260820f";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260820f";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260820f";
import { translateMuscle } from "./exerciseI18n.js?v=20260820f";

...
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260822m";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260822m";
import { openProductResult } from "./scan.js?v=20260822m";
import { openWorkoutDiary } from "./workoutDiary.js?v=20260822m";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260822m";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260822m";
import { translateMuscle } from "./exerciseI18n.js?v=20260822m";

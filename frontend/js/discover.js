...
import { api } from "./api.js?v=20260813j";
import { closeSheet, escapeHtml, openSheet, runOrDeferDuringSwipe, showToast, wirePillTabs } from "./ui.js?v=20260813j";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260813j";
import { openProductResult } from "./scan.js?v=20260813j";
import { openWorkoutSheet } from "./progress.js?v=20260813j";
import { cacheDiscoverList, getCachedDiscoverList } from "./db.js?v=20260813j";

...
import { closeSheet, escapeHtml, getActivePillType, openSheet, resetPillTabs, showToast, wirePillTabs } from "./ui.js?v=20260823g";
import { getLanguage, onLanguageChange, t } from "./i18n.js?v=20260823g";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260823g";
import { scaleMacrosByWeight } from "./nutritionMath.js?v=20260823g";
import { addRecentScan, deleteRecentScanByLogId, listRecentScans } from "./db.js?v=20260823g";
import { putHeroPhoto, removeHeroPhoto } from "./photoStore.js?v=20260823g";

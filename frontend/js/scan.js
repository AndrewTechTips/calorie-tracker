...
import { closeSheet, escapeHtml, getActivePillType, openSheet, resetPillTabs, showToast, wirePillTabs } from "./ui.js?v=20260817f";
...
import { scaleMacrosByWeight } from "./nutritionMath.js?v=20260817f";
import { addRecentScan, deleteRecentScanByLogId, listRecentScans } from "./db.js?v=20260817f";
import { putHeroPhoto, removeHeroPhoto } from "./photoStore.js?v=20260817f";

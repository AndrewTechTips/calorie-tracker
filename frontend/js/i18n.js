...
const dict = {
  en: {
    ...
    saved: {
      ...
      tabProducts: "Products",
      tabScans: "Scans",
      scansEmpty: "Nothing scanned yet. Photos from AI/barcode scans you log will show up here.",
      scanEntryExpired: "This entry is from outside the 7-day history window, so its full details are no longer available.",
      typeMeal: "Meal",
      typeProduct: "Product",
  ...
  ro: {
    ...
    saved: {
      ...
      tabProducts: "Produse",
      tabScans: "Scanări",
      scansEmpty: "Nimic scanat încă. Fotografiile din scanările AI/cod de bare pe care le înregistrezi vor apărea aici.",
      scanEntryExpired: "Această înregistrare este din afara ferestrei de istoric de 7 zile, deci detaliile complete nu mai sunt disponibile.",
      typeMeal: "Masă",
      typeProduct: "Produs",
    ...
    scan: {
      ...
      recentScansTitle: "Scanări recente",
    },
    tutorial: {

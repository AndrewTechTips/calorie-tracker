...
const dict = {
  en: {
    ...
    tutorial: {
      ...
      ringBody: "This shows calories remaining today, plus your protein, carbs, fats, and fiber underneath.",
  ...
  ro: {
    ...
    tutorial: {
      ...
      ringBody: "Aici vezi caloriile rămase azi, plus proteinele, carbohidrații, grăsimile și fibrele dedesubt.",

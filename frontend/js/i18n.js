...
const dict = {
  en: {
    ...
    ingredients: {
      ...
      unnamed: "Ingredient",
      labelToggleAriaLabel: "Nutrition label mode — enter per-100g/serving values and auto-scale",
      labelHeading: "As shown on the label, per",
      labelAmountUnit: "g",
      eatenWeightLabel: "Amount you're eating (g)",
      quickWeightAriaLabel: "Quick portion sizes",
      calorieHint: "≈ {{value}} kcal from macros — tap to use",
    },
    manual: {
  ...
  ro: {
    ...
    ingredients: {
      ...
      unnamed: "Ingredient",
      labelToggleAriaLabel: "Mod etichetă nutrițională — introdu valori per 100g/porție și scalează automat",
      labelHeading: "Cum apare pe etichetă, la fiecare",
      labelAmountUnit: "g",
      eatenWeightLabel: "Cantitatea consumată (g)",
      quickWeightAriaLabel: "Porții rapide",
      calorieHint: "≈ {{value}} kcal din macronutrienți — atinge pentru a folosi",
    },
    manual: {

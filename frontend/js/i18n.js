...
const dict = {
  en: {
    ...
    dashboard: {
      statusBannerAriaLabel: "Open AI Coach",
      kcalLeft: "kcal left",
      kcalOver: "kcal over",
      protein: "Protein",
      carbs: "Carbs",
    ...
    aiCoach: {
      ...
      chatError: "Couldn't reach the coach right now. Please try again.",
    },
    progress: {
      ...
      groupSuggestions: "Smart suggestions",
    ...
    suggestions: {
      ...
      subtitle: "Picked from your saved meals and training history to fit where you are today",
      foodHeading: "Food",
  ...
  ro: {
    ...
    dashboard: {
      statusBannerAriaLabel: "Deschide AI Coach",
    ...
    aiCoach: {
      ...
      chatError: "Nu am putut contacta antrenorul acum. Te rugăm să încerci din nou.",
    },
    progress: {
      ...
      groupSuggestions: "Sugestii inteligente",
    ...
    suggestions: {
      title: "Ce să înregistrezi în continuare",
      subtitle: "Alese din mesele tale salvate și din istoricul de antrenament pentru a se potrivi cu ziua de azi",
      foodHeading: "Mâncare",

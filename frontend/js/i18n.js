...
const dict = {
  en: {
    ...
    workouts: {
      ...
      cardSubtitle: "Your full training log — calendar, sessions, and sets, kept separate from this scroll.",
  ...
  ro: {
    ...
    workouts: {
      ...
      cardSubtitle: "Jurnalul tău complet de antrenament — calendar, sesiuni și seturi, separat de acest ecran.",

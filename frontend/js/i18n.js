...
const dict = {
  en: {
    ...
    aiCoach: {
      ...
      title: "AI Coach",
      questionsHint: "Tap a question — answered instantly from your own data, no AI call needed.",
      ...
      viewRecapBtn: "Show my weekly recap",
      recapLoading: "Generating…",
      ...
      chatHint: "A few free-form questions a day, on top of the instant ones above.",
      chatRemainingToday: "{{count}} left today.",
      chatCappedToday: "You've used today's questions — the quick-answer ones above are still free anytime. Resets at midnight.",
  ...
  ro: {
    ...
    aiCoach: {
      ...
      title: "Antrenor AI",
      questionsHint: "Atinge o întrebare — răspuns instant din datele tale, fără apel AI.",
      ...
      viewRecapBtn: "Arată recapitularea săptămânală",
      recapLoading: "Se generează…",
      recapError: "Nu am putut genera recapitularea săptămânală acum. Te rugăm să încerci din nou.",
      chatLabel: "Întreabă-mă orice",
      ...
      chatHint: "Câteva întrebări libere pe zi, pe lângă cele instant de mai sus.",
      chatRemainingToday: "{{count}} rămase azi.",
      chatCappedToday: "Ai folosit întrebările de azi — cele cu răspuns instant de mai sus sunt gratuite oricând. Se resetează la miezul nopții.",

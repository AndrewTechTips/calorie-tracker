...
const dict = {
  en: {
    ...
    aiCoach: {
      ...
      petMoodSick: "Sick",
      petFedGeneric: "Thanks for feeding me!",
      petFeedLine1: "Mmm, {{food}}? Nice choice!",
      petFeedLine2: "Yes! {{food}} logged — thank you!",
      petFeedLine3: "Ooh, {{food}}. My belly (and yours) says thanks.",
      petFeedLine4: "Logged: {{food}}. Feeling better already!",
      petHydrateLine1: "Ahh, {{amount}} ml of water — refreshing!",
      petHydrateLine2: "Hydration +{{amount}} ml. Cheers to that!",
      petHydrateLine3: "Glug glug! {{amount}} ml logged.",
      petHydrateLine4: "Nice, {{amount}} ml down. Staying fresh!",
  ...
  ro: {
    ...
    aiCoach: {
      ...
      petMoodSick: "Bolnav",
      petFedGeneric: "Mulțumesc pentru masă!",
      petFeedLine1: "Mmm, {{food}}? Alegere bună!",
      petFeedLine2: "Da! Am notat {{food}} — mulțumesc!",
      petFeedLine3: "Ooo, {{food}}. Burtica mea (și a ta) îți mulțumește.",
      petFeedLine4: "Înregistrat: {{food}}. Mă simt deja mai bine!",
      petHydrateLine1: "Aah, {{amount}} ml de apă — revigorant!",
      petHydrateLine2: "Hidratare +{{amount}} ml. Noroc!",
      petHydrateLine3: "Glu-glu! {{amount}} ml înregistrați.",
      petHydrateLine4: "Bravo, {{amount}} ml. Rămâi proaspăt!",

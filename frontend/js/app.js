import { api, warmBackend } from "./api.js?v=20260820d";
import { initAuth, logOut } from "./auth.js?v=20260820d";
import {
...
} from "./scan.js?v=20260820d";
import { initProgress, renderProgress, syncLiveTotals } from "./progress.js?v=20260820d";
import { initWorkoutDiary } from "./workoutDiary.js?v=20260820d";
import { initAnalytics, renderAnalyticsInsights, setContext as setAnalyticsContext } from "./analytics.js?v=20260820d";
import { initReminders, setContext as setReminderContext } from "./reminders.js?v=20260820d";
import { setContext as setAiCoachContext } from "./aiCoach.js?v=20260820d";
import { initCoachChat } from "./coachChat.js?v=20260820d";
import { initDamageControl, maybeTriggerDamageControl } from "./damageControl.js?v=20260820d";
import { renderAIUsage } from "./aiUsage.js?v=20260820d";
import { initFastingTimer } from "./fastingTimer.js?v=20260820d";
import {
  initMealSuggester,
  openMealSuggesterSheet,
  setContext as setMealSuggesterContext,
  setDayLocked as setMealSuggesterDayLocked,
} from "./mealSuggester.js?v=20260820d";
import { initDiscover, onDiscoverTabOpened, setDiscoverContext } from "./discover.js?v=20260820d";
import { setSuggestionsContext } from "./suggestions.js?v=20260820d";
import { initTutorial, maybeAutoStartTutorial, setTutorialContext } from "./tutorial.js?v=20260820d";
import { initScrollProgress } from "./scrollProgress.js?v=20260820d";
import {
  animateItemRemoval,
  closeAllSheets,
  closeSheet,
  ...
  vibrate,
  wirePillTabs,
} from "./ui.js?v=20260820d";
import { getLanguage, getLocale, initI18n, onLanguageChange, setLanguage, t } from "./i18n.js?v=20260820d";
import { getCalorieStatus } from "./coach.js?v=20260820d";
import { calculateTargets, roundTo1 } from "./nutritionMath.js?v=20260820d";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260820d";
import {
  cacheFoodNames,
  countQueuedWrites,
...
} from "./db.js?v=20260820d";
import { fireConfetti } from "./confetti.js?v=20260820d";
import { fileToAvatarDataUrl, isImageFile, resolveAvatarUrl } from "./avatar.js?v=20260820d";
import { getLastUpdated as getLegalLastUpdated, getLegalDoc, renderLegalSectionsHtml } from "./legalContent.js?v=20260820d";
import { initPhotoStore, purgeStalePhotos, removeHeroPhoto } from "./photoStore.js?v=20260820d";
import { initPhotoLightbox, openPhotoLightbox } from "./photoLightbox.js?v=20260820d";
import {
  archivePdfReport,
  ...
  initPdfArchiveStore,
  listArchivedReports,
} from "./pdfArchiveStore.js?v=20260820d";
...
async function registerPdfFonts(doc) {
  ...
  const { NOTO_SANS_BOLD_B64, NOTO_SANS_REGULAR_B64 } = await import("./pdfFonts.js?v=20260820d");

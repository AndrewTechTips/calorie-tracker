import { api, warmBackend } from "./api.js?v=20260822b";
import { initAuth, logOut } from "./auth.js?v=20260822b";
import {
...
} from "./scan.js?v=20260822b";
import { initProgress, renderProgress, syncLiveTotals } from "./progress.js?v=20260822b";
import { initWorkoutDiary } from "./workoutDiary.js?v=20260822b";
import { initAnalytics, renderAnalyticsInsights, setContext as setAnalyticsContext } from "./analytics.js?v=20260822b";
import { initNotifications } from "./notifications.js?v=20260822b";
import { setContext as setAiCoachContext } from "./aiCoach.js?v=20260822b";
import { initCoachChat } from "./coachChat.js?v=20260822b";
import { initDamageControl, maybeTriggerDamageControl } from "./damageControl.js?v=20260822b";
import { renderAIUsage } from "./aiUsage.js?v=20260822b";
import { initFastingTimer } from "./fastingTimer.js?v=20260822b";
import {
  initMealSuggester,
  openMealSuggesterSheet,
  setContext as setMealSuggesterContext,
  setDayLocked as setMealSuggesterDayLocked,
} from "./mealSuggester.js?v=20260822b";
import { initDiscover, onDiscoverTabOpened, setDiscoverContext } from "./discover.js?v=20260822b";
import { setSuggestionsContext } from "./suggestions.js?v=20260822b";
import { initTutorial, maybeAutoStartTutorial, setTutorialContext } from "./tutorial.js?v=20260822b";
import { initScrollProgress } from "./scrollProgress.js?v=20260822b";
import {
  animateItemRemoval,
  closeAllSheets,
  closeSheet,
...
import { getLanguage, getLocale, initI18n, onLanguageChange, setLanguage, t } from "./i18n.js?v=20260822b";
import { getCalorieStatus } from "./coach.js?v=20260822b";
import { calculateTargets, roundTo1 } from "./nutritionMath.js?v=20260822b";
...
} from "./db.js?v=20260822b";
import { fireConfetti } from "./confetti.js?v=20260822b";
import { fileToAvatarDataUrl, isImageFile, resolveAvatarUrl } from "./avatar.js?v=20260822b";
import { getLastUpdated as getLegalLastUpdated, getLegalDoc, renderLegalSectionsHtml } from "./legalContent.js?v=20260822b";
import { initPhotoStore, purgeStalePhotos, removeHeroPhoto } from "./photoStore.js?v=20260822b";
import { initPhotoLightbox, openPhotoLightbox } from "./photoLightbox.js?v=20260822b";
import {
  archivePdfReport,
  ...
  initPdfArchiveStore,
  listArchivedReports,
} from "./pdfArchiveStore.js?v=20260822b";
...
async function registerPdfFonts(doc) {
  ...
  const { NOTO_SANS_BOLD_B64, NOTO_SANS_REGULAR_B64 } = await import("./pdfFonts.js?v=20260822b");

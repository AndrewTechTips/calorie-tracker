import { api, warmBackend } from "./api.js?v=20260822w";
import { initAuth, logOut } from "./auth.js?v=20260822w";
import {
...
} from "./scan.js?v=20260822w";
import { initProgress, renderProgress, syncLiveTotals } from "./progress.js?v=20260822w";
import { initWorkoutDiary } from "./workoutDiary.js?v=20260822w";
import { initAnalytics, renderAnalyticsInsights, setContext as setAnalyticsContext } from "./analytics.js?v=20260822w";
import { initNotifications } from "./notifications.js?v=20260822w";
import { setContext as setAiCoachContext } from "./aiCoach.js?v=20260822w";
import { initCoachChat } from "./coachChat.js?v=20260822w";
import { PetHud } from "./petHud.js?v=20260822w";
import { initDamageControl, maybeTriggerDamageControl } from "./damageControl.js?v=20260822w";
import { renderAIUsage } from "./aiUsage.js?v=20260822w";
import { initFastingTimer } from "./fastingTimer.js?v=20260822w";
import {
  initMealSuggester,
  openMealSuggesterSheet,
  setContext as setMealSuggesterContext,
  setDayLocked as setMealSuggesterDayLocked,
} from "./mealSuggester.js?v=20260822w";
import { initDiscover, onDiscoverTabOpened, setDiscoverContext } from "./discover.js?v=20260822w";
import { setSuggestionsContext } from "./suggestions.js?v=20260822w";
import { initTutorial, maybeAutoStartTutorial, setTutorialContext } from "./tutorial.js?v=20260822w";
import { initScrollProgress } from "./scrollProgress.js?v=20260822w";
import {
  animateItemRemoval,
  closeAllSheets,
  closeSheet,
...
import { getLanguage, getLocale, initI18n, onLanguageChange, setLanguage, t } from "./i18n.js?v=20260822w";
import { getCalorieStatus } from "./coach.js?v=20260822w";
import { calculateTargets, roundTo1 } from "./nutritionMath.js?v=20260822w";
import { asImplicitIngredient, createIngredientsEditor } from "./ingredientsList.js?v=20260822w";
import {
  cacheFoodNames,
  countQueuedWrites,
...
} from "./db.js?v=20260822w";
import { fireConfetti } from "./confetti.js?v=20260822w";
import { fileToAvatarDataUrl, isImageFile, resolveAvatarUrl } from "./avatar.js?v=20260822w";
import { getLastUpdated as getLegalLastUpdated, getLegalDoc, renderLegalSectionsHtml } from "./legalContent.js?v=20260822w";
import { initPhotoStore, purgeStalePhotos, removeHeroPhoto } from "./photoStore.js?v=20260822w";
import { initPhotoLightbox, openPhotoLightbox } from "./photoLightbox.js?v=20260822w";
import {
  archivePdfReport,
  ...
  initPdfArchiveStore,
  listArchivedReports,
} from "./pdfArchiveStore.js?v=20260822w";
...
async function registerPdfFonts(doc) {
  ...
  const { NOTO_SANS_BOLD_B64, NOTO_SANS_REGULAR_B64 } = await import("./pdfFonts.js?v=20260822w");

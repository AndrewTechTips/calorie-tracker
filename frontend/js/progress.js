...
import { getLocale, onLanguageChange, t } from "./i18n.js?v=20260817i";
import { computeStreakWithFreeze, daysUntilNextFreeze } from "./streakFreeze.js?v=20260817i";
import { computeEMA, computeLinearTrendRate, computeWeightForecast } from "./nutritionMath.js?v=20260817i";
import { initSuggestions } from "./suggestions.js?v=20260817i";
import { getCachedSessions, getCachedSets, loadWorkoutSessions } from "./workoutDiary.js?v=20260817i";

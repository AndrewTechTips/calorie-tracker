...
import { getLocale, onLanguageChange, t } from "./i18n.js?v=20260820h";
import { computeStreakWithFreeze, daysUntilNextFreeze } from "./streakFreeze.js?v=20260820h";
import { computeEMA, computeLinearTrendRate, computeWeightForecast } from "./nutritionMath.js?v=20260820h";
import { initSuggestions } from "./suggestions.js?v=20260820h";
import { getCachedSessions, getCachedSets, loadWorkoutSessions } from "./workoutDiary.js?v=20260820h";

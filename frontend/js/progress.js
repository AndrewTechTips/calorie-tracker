...
import { getLocale, onLanguageChange, t } from "./i18n.js?v=20260811f";
import { computeStreakWithFreeze, daysUntilNextFreeze } from "./streakFreeze.js?v=20260811f";
import { computeEMA, computeLinearTrendRate, computeWeightForecast } from "./nutritionMath.js?v=20260811f";
import { initSuggestions, renderSuggestions } from "./suggestions.js?v=20260811f";

...
import { getLocale, onLanguageChange, t } from "./i18n.js?v=20260820f";
import { computeStreakWithFreeze, daysUntilNextFreeze } from "./streakFreeze.js?v=20260820f";
import { computeEMA, computeLinearTrendRate, computeWeightForecast } from "./nutritionMath.js?v=20260820f";
import { initSuggestions } from "./suggestions.js?v=20260820f";
import { getCachedSessions, getCachedSets, loadWorkoutSessions } from "./workoutDiary.js?v=20260820f";

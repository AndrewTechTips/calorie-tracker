...
import { caloriesFromMacros, estimateFiberFromCarbs, roundTo1, scaleMacrosByWeight } from "./nutritionMath.js?v=20260821f";
import { t } from "./i18n.js?v=20260821f";
import { escapeHtml } from "./ui.js?v=20260821f";

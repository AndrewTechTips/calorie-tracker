...
import { caloriesFromMacros, estimateFiberFromCarbs, roundTo1, scaleMacrosByWeight } from "./nutritionMath.js?v=20260811f";
import { t } from "./i18n.js?v=20260811f";
import { escapeHtml } from "./ui.js?v=20260811f";

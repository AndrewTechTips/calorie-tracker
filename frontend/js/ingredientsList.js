...
import { estimateFiberFromCarbs, roundTo1, scaleMacrosByWeight } from "./nutritionMath.js?v=20260805h{";
import { t } from "./i18n.js?v=20260805h{";
import { escapeHtml } from "./ui.js?v=20260805h{";

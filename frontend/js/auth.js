import { supabaseClient } from "./supabaseClient.js?v=20260814l";
import { getLanguage, onLanguageChange, setLanguage, t } from "./i18n.js?v=20260814l";
import { TURNSTILE_SITE_KEY } from "./config.js?v=20260814l";
import { showToast } from "./ui.js?v=20260814l";
import { api } from "./api.js?v=20260814l";
import { fileToAvatarDataUrl, isImageFile } from "./avatar.js?v=20260814l";

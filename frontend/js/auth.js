import { supabaseClient } from "./supabaseClient.js?v=20260819d";
import { getLanguage, onLanguageChange, setLanguage, t } from "./i18n.js?v=20260819d";
import { TURNSTILE_SITE_KEY } from "./config.js?v=20260819d";
import { showToast } from "./ui.js?v=20260819d";
import { api } from "./api.js?v=20260819d";
import { fileToAvatarDataUrl, isImageFile } from "./avatar.js?v=20260819d";

...
RECIPES = [
    # Curated in four loose tiers, all sharing the same bilingual shape,
    # realistic-per-serving-estimate honesty and Wikimedia Commons photo
    # sourcing (hotlinked via Special:FilePath, same trust model as the
    # exercise/product images):
    #   1. Romanian traditional dishes — kept as the launch identity
    #   2. "Signature" global bowls & plates — restaurant-caliber, the
    #      visually-driven top of the catalog
    #   3. Everyday high-protein plates & meal-prep
    #   4. Breakfast, snacks & something sweet
    # Several dishes in a family share an `icon` on purpose (see the
    # module docstring) — it is category art, not a per-dish photo.
    {
        "id": "ro-ciorba-legume",
        "icon": "soup",
        "name": {"en": "Ciorbă de legume (Romanian vegetable soup)", "ro": "Ciorbă de legume"},
        "tagline": {
            "en": "The lemon-sharp vegetable broth that resets a heavy week — bright, restorative, barely 145 kcal a bowl.",
            "ro": "Ciorba de legume cu accent de lămâie care repune pe picioare o săptămână grea — proaspătă, reconfortantă, abia 145 kcal porția.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Sour, herb-flecked broth around tender pork-and-rice meatballs — Sunday-lunch soup with a weekday macro sheet.",
            "ro": "Bulion acrișor cu verdeață în jurul unor perișoare fragede de porc și orez — ciorba de duminică, cu macronutrienți de zi lucrătoare.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Cabbage rolls braised two hours until they surrender — Romania's centerpiece dish, built for a genuine appetite.",
            "ro": "Sarmale fierte două ore până se topesc în gură — preparatul de rezistență al României, pe măsura unei pofte adevărate.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Peppers braised low until sweet, packed with real meat and rice — comfort food that still logs clean.",
            "ro": "Ardei fierți la foc mic până devin dulci, umpluți cu carne adevărată și orez — mâncare de suflet care se încadrează totuși curat.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Paprika-deep chicken stew over soft polenta — rustic, generous, 32 grams of protein a plate.",
            "ro": "Tocăniță de pui bogată în boia, peste mămăligă moale — rustică, generoasă, 32 de grame de proteină în farfurie.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Garlic-heavy, charred at the edges, unmistakably Romanian — the grill classic that's basically seasoned protein.",
            "ro": "Cu mult usturoi, rumeniți pe muchii, inconfundabil românești — clasicul de grătar care e, practic, proteină condimentată.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Silky white-bean purée under a tangle of caramelized onion — nine grams of fiber that eats like a treat.",
            "ro": "Piure mătăsos de fasole sub un cuib de ceapă caramelizată — nouă grame de fibre cu gust de răsfăț.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Fire-blistered eggplant whipped airy with oil and onion — a diet-food classic that never once tastes like one.",
            "ro": "Vinete pârlite pe flacără, bătute spumos cu ulei și ceapă — un clasic „de regim” care nu are niciodată gust de regim.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Smoky roasted-pepper spread on charred bread — Romania's answer to bruschetta, ready before the kettle boils.",
            "ro": "Zacuscă afumată de ardei copt pe pâine rumenită — răspunsul românesc la bruschetă, gata înainte să fiarbă apa.",
        },
        "tags": ["romanian", "vegetarian", "quick", "low-calorie", "maintain"],
    ...
    },
    {
        ...
        "tagline": {
            "en": "Golden fried cheese dumplings under sour cream and jam — the Romanian dessert worth planning a surplus around.",
            "ro": "Papanași aurii, prăjiți, sub smântână și dulceață — desertul românesc pentru care merită să-ți faci loc în calorii.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Sushi-counter poke, assembled on your own counter in twenty minutes flat.",
            "ro": "Poke ca la barul de sushi, asamblat pe blatul tău în exact douăzeci de minute.",
        },
    ...
    {
        "id": "global-salmon-poke-bowl",
        "icon": "bowl",
        "name": {"en": "Salmon poke bowl", "ro": "Bol poke cu somon"},
        "tagline": {
            "en": "Cubed raw salmon in a sesame-soy dressing over rice, built with avocado, edamame and a snap of cucumber.",
            "ro": "Somon crud tăiat cuburi într-un dressing de susan și soia, peste orez, cu avocado, edamame și castravete crocant.",
        },
        "tags": ["high-protein", "quick", "meal-prep", "cut"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Salmon%20Poke.jpg",
        "prep_minutes": 15,
        "servings": 1,
        "weight_g": 420,
        "calories": 480,
        ...
        "ingredients": {
            "en": [
                ...
                "120g cooked sushi rice, cooled",
                "1 tbsp soy sauce, 1 tsp sesame oil, 1 tsp rice vinegar, 1 tsp honey",
                "1/4 avocado, sliced",
                "50g shelled edamame",
                "1/4 cucumber, sliced; 2 radishes, thinly sliced",
                "Sesame seeds, nori strips and scallion, to finish",
            ],
            "ro": [
                "150g somon calitate sushi, tăiat cuburi",
                "120g orez sushi fiert, răcit",
                "1 lingură sos de soia, 1 linguriță ulei de susan, 1 linguriță oțet de orez, 1 linguriță miere",
                "1/4 avocado, feliat",
                "50g edamame decorticat",
                "1/4 castravete, feliat; 2 ridichi, feliate subțire",
                "Semințe de susan, fâșii de nori și ceapă verde, pentru finisare",
            ],
        },
        "instructions": {
            "en": [
                "Whisk the soy sauce, sesame oil, rice vinegar and honey together.",
                "Gently toss the cubed salmon in half the dressing and let it sit 5 minutes.",
                "Spread the rice in a bowl and arrange the salmon, avocado, edamame, cucumber and radish on top.",
                "Drizzle over the rest of the dressing and finish with sesame seeds, nori and scallion.",
            ],
            "ro": [
                "Amestecă sosul de soia, uleiul de susan, oțetul de orez și mierea.",
                "Amestecă ușor cuburile de somon în jumătate din dressing și lasă-le 5 minute.",
                "Întinde orezul în bol și aranjează deasupra somonul, avocado, edamame, castravetele și ridichea.",
                "Toarnă restul de dressing și finalizează cu semințe de susan, nori și ceapă verde.",
            ],
        },
    },
    {
        ...
        "tagline": {
            "en": "A lacquer-glossy miso glaze that turns a weeknight fillet into a plated occasion.",
            "ro": "O glazură de miso lucioasă ca lacul care transformă un file de zi cu zi într-un fel de ocazie.",
        },
    ...
    {
        "id": "global-teriyaki-salmon-bowl",
        "icon": "fish",
        "name": {"en": "Teriyaki salmon rice bowl", "ro": "Bol cu orez și somon teriyaki"},
        "tagline": {
            "en": "A sticky, mirror-shine glaze reduced right onto the fillet — salmon over rice with sesame and scallion.",
            "ro": "O glazură lipicioasă, lucioasă ca oglinda, redusă chiar pe file — somon peste orez, cu susan și ceapă verde.",
        },
        "tags": ["high-protein", "balanced", "meal-prep", "bulk"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Grilled%20Teriyaki%20Salmon%20(10900376705).jpg",
        "prep_minutes": 20,
        "servings": 1,
        "weight_g": 420,
        "calories": 560,
        ...
        "ingredients": {
            "en": [
                "200g salmon fillet",
                "2 tbsp soy sauce, 1 tbsp mirin, 1 tbsp honey, 1 tsp grated ginger",
                "150g cooked rice",
                "100g steamed broccoli or edamame",
                "1 spring onion, sliced; 1 tsp sesame seeds",
            ],
            "ro": [
                "200g file de somon",
                "2 linguri sos de soia, 1 lingură mirin, 1 lingură miere, 1 linguriță ghimbir ras",
                "150g orez fiert",
                "100g broccoli la abur sau edamame",
                "1 fir de ceapă verde, feliat; 1 linguriță semințe de susan",
            ],
        },
        "instructions": {
            "en": [
                "Simmer the soy, mirin, honey and ginger in a small pan for 2-3 minutes until slightly syrupy.",
                "Sear the salmon skin-side down for 3-4 minutes, flip, then spoon the glaze over and cook 2-3 minutes more, basting, until lacquered.",
                "Serve over rice with the broccoli or edamame.",
                "Pour any pan glaze over the top and finish with spring onion and sesame seeds.",
            ],
            "ro": [
                "Fierbe sosul de soia, mirinul, mierea și ghimbirul într-o crăticioară 2-3 minute, până devine ușor siropos.",
                "Prăjește somonul cu pielea în jos 3-4 minute, întoarce-l, apoi toarnă glazura peste el și mai gătește 2-3 minute, ungând, până se lăcuiește.",
                "Servește peste orez, cu broccoli sau edamame.",
                "Toarnă glazura rămasă în tigaie deasupra și finalizează cu ceapă verde și semințe de susan.",
            ],
        },
    },
    {
        ...
        "tagline": {
            "en": "Sweet, fierce, deeply savory — a bibimbap-style bowl that makes a surplus day feel earned.",
            "ro": "Dulce, iute, intens savuros — un bol stil bibimbap care face o zi de surplus să pară meritată.",
        },
    ...
    {
        "id": "global-bulgogi-bibimbap",
        "icon": "bowl",
        "name": {"en": "Beef bulgogi bibimbap bowl", "ro": "Bol bibimbap cu vită bulgogi"},
        "tagline": {
            "en": "Sweet-soy marinated beef, a glossy fried egg, vegetables in neat lanes — the bowl you mix at the table.",
            "ro": "Vită marinată în sos de soia dulce, un ou ochi lucios, legume aranjate pe benzi — bolul pe care îl amesteci la masă.",
        },
        "tags": ["high-protein", "meal-prep", "bulk"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Bulgogi%20Bibimbap,%20a%20Korean%20dish.jpg",
        "prep_minutes": 25,
        "servings": 1,
        "weight_g": 450,
        "calories": 560,
        ...
        "ingredients": {
            "en": [
                "200g thinly sliced lean beef (sirloin)",
                "1 tbsp soy sauce, 1 tsp brown sugar, 1 tsp sesame oil, 1 clove garlic, minced",
                "150g cooked short-grain rice",
                "1 egg",
                "80g spinach, blanched",
                "60g carrot, julienned",
                "60g bean sprouts",
                "1 tbsp gochujang and sesame seeds, to serve",
            ],
            "ro": [
                "200g vită slabă feliată subțire (mușchi)",
                "1 lingură sos de soia, 1 linguriță zahăr brun, 1 linguriță ulei de susan, 1 cățel de usturoi tocat",
                "150g orez cu bob rotund, fiert",
                "1 ou",
                "80g spanac, oparit",
                "60g morcov, julienne",
                "60g germeni de soia",
                "1 lingură gochujang și semințe de susan, la servire",
            ],
        },
        "instructions": {
            "en": [
                "Marinate the beef in the soy, sugar, sesame oil and garlic for at least 10 minutes.",
                "Sear the beef in a hot pan for 2-3 minutes until caramelized; set aside, then fry the egg in the same pan.",
                "Warm or quickly sauté the spinach, carrot and bean sprouts separately, seasoning each lightly.",
                "Arrange everything over the rice in sections, add the egg and a spoon of gochujang, and mix thoroughly before eating.",
            ],
            "ro": [
                "Marinează vita în sos de soia, zahăr, ulei de susan și usturoi cel puțin 10 minute.",
                "Prăjește vita într-o tigaie încinsă 2-3 minute până se caramelizează; dă-o deoparte, apoi fă oul ochi în aceeași tigaie.",
                "Încălzește sau călește rapid spanacul, morcovul și germenii separat, condimentând ușor fiecare.",
                "Aranjează totul peste orez, pe secțiuni, adaugă oul și o lingură de gochujang și amestecă bine înainte de a mânca.",
            ],
        },
    },
    {
        "id": "global-chicken-shawarma-bowl",
        "icon": "bowl",
        "name": {"en": "Chicken shawarma bowl with garlic-lemon yogurt", "ro": "Bol shawarma cu pui și iaurt cu usturoi și lămâie"},
        "tagline": {
            "en": "The spice rub off the street cart, the plating of a fast-casual bowl — 44 grams of protein, under 550 kcal.",
            "ro": "Amestecul de condimente de la taraba din colț, prezentarea unui bol modern — 44 de grame de proteină, sub 550 kcal.",
        },
        "tags": ["high-protein", "meal-prep", "bulk", "quick"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Chicken%20Shwarama%20plate.jpeg",
        "prep_minutes": 20,
        "servings": 1,
        "weight_g": 430,
        "calories": 540,
        ...
        "ingredients": {
            "en": [
                "200g chicken thighs, boneless, sliced",
                "1 tsp each cumin, coriander, smoked paprika; 1/2 tsp turmeric; pinch of cinnamon",
                "1 tbsp olive oil",
                "150g cooked rice, or 1 warm pita torn into pieces",
                "80g cucumber and tomato, diced",
                "2 tbsp plain Greek yogurt",
                "1 small clove garlic, grated; squeeze of lemon",
                "Pickled turnips or red onion, to finish",
            ],
            "ro": [
                "200g pulpe de pui dezosate, feliate",
                "Câte 1 linguriță de chimen, coriandru, boia afumată; 1/2 linguriță turmeric; un vârf de scorțișoară",
                "1 lingură ulei de măsline",
                "150g orez fiert, sau 1 lipie caldă ruptă în bucăți",
                "80g castravete și roșie, tăiate cubulețe",
                "2 linguri iaurt grecesc simplu",
                "1 cățel mic de usturoi, ras; puțină zeamă de lămâie",
                "Gogoșari murați sau ceapă roșie, pentru finisare",
            ],
        },
        "instructions": {
            "en": [
                "Toss the chicken with the spices and olive oil and let it sit 10 minutes if you have time.",
                "Sear in a hot pan for 6-8 minutes, turning, until charred at the edges and cooked through.",
                "Stir the garlic and lemon into the yogurt with a pinch of salt.",
                "Build the bowl: rice or pita, the chicken, the chopped salad, a spoon of garlic yogurt, and the pickles on top.",
            ],
            "ro": [
                "Amestecă puiul cu mirodeniile și uleiul de măsline și lasă-l 10 minute dacă ai timp.",
                "Prăjește-l într-o tigaie încinsă 6-8 minute, întorcând, până e rumenit pe margini și pătruns.",
                "Amestecă usturoiul și lămâia în iaurt, cu un praf de sare.",
                "Asamblează bolul: orez sau lipie, puiul, salata tăiată, o lingură de iaurt cu usturoi și murăturile deasupra.",
            ],
        },
    },
    {
        "id": "global-chicken-souvlaki-bowl",
        "icon": "bowl",
        "name": {"en": "Greek chicken souvlaki bowl", "ro": "Bol grecesc cu souvlaki de pui"},
        "tagline": {
            "en": "Oregano-lemon chicken off the skewer, cool tzatziki, a sharp village salad — a taverna plate you can meal-prep.",
            "ro": "Pui cu oregano și lămâie de pe frigăruie, tzatziki rece, o salată țărănească aspră — o farfurie de tavernă pe care o poți pregăti din timp.",
        },
        "tags": ["high-protein", "meal-prep", "balanced", "maintain"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Greek%20chicken%20souvlaki%20merida.jpg",
        "prep_minutes": 25,
        "servings": 1,
        "weight_g": 440,
        "calories": 500,
        ...
        "ingredients": {
            "en": [
                ...
                "1 tbsp olive oil, juice of 1/2 lemon, 1 tsp dried oregano, 1 clove garlic",
                "120g cooked rice, or 1 warm pita",
                "80g cucumber, 80g tomato, 1/4 red onion, chopped",
                "3 tbsp tzatziki (Greek yogurt, grated cucumber, garlic, dill)",
                "20g feta, crumbled",
            ],
            "ro": [
                "220g piept de pui, tăiat cuburi",
                "1 lingură ulei de măsline, zeama de la 1/2 lămâie, 1 linguriță oregano uscat, 1 cățel de usturoi",
                "120g orez fiert, sau 1 lipie caldă",
                "80g castravete, 80g roșie, 1/4 ceapă roșie, tocate",
                "3 linguri tzatziki (iaurt grecesc, castravete ras, usturoi, mărar)",
                "20g feta, sfărâmată",
            ],
        },
        "instructions": {
            "en": [
                "Marinate the chicken in the oil, lemon, oregano and garlic for 15 minutes, then thread onto skewers if you have them.",
                "Grill or pan-sear over high heat for 8-10 minutes until charred and cooked through.",
                "Toss the cucumber, tomato and onion with a little olive oil and salt for the salad.",
                "Serve the chicken over rice or with pita, alongside the salad, tzatziki and crumbled feta.",
            ],
            "ro": [
                "Marinează puiul în ulei, lămâie, oregano și usturoi 15 minute, apoi pune-l pe frigărui dacă ai.",
                "Frige pe grătar sau în tigaie la foc mare 8-10 minute până e rumenit și pătruns.",
                "Amestecă castravetele, roșia și ceapa cu puțin ulei de măsline și sare pentru salată.",
                "Servește puiul peste orez sau cu lipie, alături de salată, tzatziki și feta sfărâmată.",
            ],
        },
    },
    {
        ...
        "tagline": {
            "en": "Harissa-red, mint-cooled, genuinely filling — a power bowl that doesn't taste like a spreadsheet.",
            "ro": "Roșu de la harissa, răcorit cu mentă, cu adevărat sățios — un bol energizant care nu are gust de tabel.",
        },
    ...
    {
        "id": "global-tandoori-chicken",
        "icon": "grill",
        "name": {"en": "Tandoori chicken with mint-yogurt", "ro": "Pui tandoori cu iaurt de mentă"},
        "tagline": {
            "en": "A double yogurt-and-spice marinade stains it deep red and keeps it absurdly juicy — high heat does the rest.",
            "ro": "O marinată dublă de iaurt și mirodenii îl colorează roșu-închis și îl păstrează absurd de suculent — focul mare face restul.",
        },
        "tags": ["high-protein", "grill", "low-calorie", "cut", "meal-prep"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Grilled%20Tandoori%20chicken.jpg",
        "prep_minutes": 30,
        "servings": 3,
        "weight_g": 220,
        "calories": 300,
        ...
        "ingredients": {
            "en": [
                "700g chicken thighs or drumsticks, skinless, slashed",
                "150g plain yogurt",
                "1 tbsp each grated ginger and garlic",
                "1 tbsp lemon juice",
                "2 tsp garam masala, 1 tsp cumin, 1 tsp smoked paprika, 1/2 tsp turmeric, 1/2 tsp chili powder",
                "For the sauce: 4 tbsp yogurt, small handful of mint, squeeze of lemon",
            ],
            "ro": [
                "700g pulpe sau pulpe inferioare de pui, fără piele, crestate",
                "150g iaurt simplu",
                "Câte 1 lingură de ghimbir și usturoi ras",
                "1 lingură zeamă de lămâie",
                "2 lingurițe garam masala, 1 linguriță chimen, 1 linguriță boia afumată, 1/2 linguriță turmeric, 1/2 linguriță ardei iute măcinat",
                "Pentru sos: 4 linguri iaurt, un pumn mic de mentă, puțină zeamă de lămâie",
            ],
        },
        "instructions": {
            "en": [
                "Rub the chicken with the lemon and a little salt, then coat in the yogurt-spice marinade; chill at least 20 minutes, ideally a few hours.",
                "Grill or roast at high heat (240°C), turning, for 20-25 minutes until charred at the edges and cooked through.",
                "Blend the sauce ingredients smooth with a pinch of salt.",
                "Serve the chicken with the mint-yogurt and lemon wedges.",
            ],
            "ro": [
                "Freacă puiul cu lămâie și puțină sare, apoi acoperă-l cu marinata de iaurt și mirodenii; ține la frigider cel puțin 20 de minute, ideal câteva ore.",
                "Frige pe grătar sau la cuptor la foc mare (240°C), întorcând, 20-25 de minute până e rumenit pe margini și pătruns.",
                "Blenduiește ingredientele pentru sos până e fin, cu un praf de sare.",
                "Servește puiul cu iaurtul de mentă și felii de lămâie.",
            ],
        },
    },
    {
        "id": "global-peri-peri-chicken",
        "icon": "grill",
        "name": {"en": "Flame-grilled peri-peri chicken", "ro": "Pui peri-peri la grătar"},
        "tagline": {
            "en": "A vivid chili-and-lemon marinade, charred hard over high heat — lean thighs with a real crust.",
            "ro": "O marinată vie de ardei iute și lămâie, rumenită agresiv la foc mare — pulpe slabe cu o crustă adevărată.",
        },
        "tags": ["high-protein", "grill", "low-calorie", "cut", "bulk"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Flame-grilled%20PERi-PERi%20chicken.jpg",
        "prep_minutes": 30,
        "servings": 2,
        "weight_g": 250,
        "calories": 330,
        ...
        "ingredients": {
            "en": [
                ...
                "3 red chilies (bird's eye or cayenne), roughly chopped",
                "3 cloves garlic",
                "Juice and zest of 1 lemon",
                "2 tbsp red wine vinegar",
                "1 tbsp olive oil",
                "1 tsp smoked paprika, 1 tsp dried oregano, salt",
            ],
            "ro": [
                "500g pulpe de pui dezosate, fără piele",
                "3 ardei iuți roșii, tocați grosier",
                "3 căței de usturoi",
                "Zeama și coaja de la 1 lămâie",
                "2 linguri oțet de vin roșu",
                "1 lingură ulei de măsline",
                "1 linguriță boia afumată, 1 linguriță oregano uscat, sare",
            ],
        },
        "instructions": {
            "en": [
                "Blend the chilies, garlic, lemon, vinegar, oil, paprika, oregano and salt into a loose marinade.",
                "Coat the chicken and marinate at least 20 minutes, or overnight in the fridge.",
                "Grill over high heat, turning every couple of minutes and basting with the marinade, for 12-15 minutes until charred and cooked through.",
                "Rest 5 minutes, then serve with any leftover marinade simmered briefly as a sauce.",
            ],
            "ro": [
                "Blenduiește ardeii iuți, usturoiul, lămâia, oțetul, uleiul, boiaua, oregano și sarea într-o marinată lejeră.",
                "Acoperă puiul și lasă-l la marinat cel puțin 20 de minute, sau peste noapte la frigider.",
                "Frige pe grătar la foc mare, întorcând la câteva minute și ungând cu marinată, 12-15 minute până e rumenit și pătruns.",
                "Lasă 5 minute la odihnă, apoi servește cu restul de marinată fiartă scurt, ca sos.",
            ],
        },
    },
    {
        "id": "global-jerk-chicken-bowl",
        "icon": "bowl",
        "name": {"en": "Jerk chicken with rice & beans", "ro": "Pui jerk cu orez și fasole"},
        "tagline": {
            "en": "A dark allspice-and-scotch-bonnet marinade with real heat — grilled chicken over coconut rice and red beans.",
            "ro": "O marinată închisă la culoare, de ienibahar și ardei iute, cu iuțeală adevărată — pui la grătar peste orez cu cocos și fasole roșie.",
        },
        "tags": ["high-protein", "meal-prep", "bulk"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Jerk%20Chicken,%20Rice.jpg",
        "prep_minutes": 35,
        "servings": 2,
        "weight_g": 450,
        "calories": 580,
        ...
        "ingredients": {
            "en": [
                ...
                "3 spring onions, 1 scotch bonnet (or to taste), 2 cloves garlic, 1 tbsp grated ginger",
                "1 tbsp soy sauce, 1 tbsp lime juice, 1 tsp allspice, 1 tsp thyme, 1/2 tsp cinnamon, 1/2 tsp nutmeg, 1 tsp brown sugar",
                "150g rice",
                "120g canned red kidney beans, drained",
                "100ml light coconut milk plus 150ml water",
            ],
            "ro": [
                "500g pulpe de pui dezosate",
                "3 fire de ceapă verde, 1 ardei iute scotch bonnet (sau după gust), 2 căței de usturoi, 1 lingură ghimbir ras",
                "1 lingură sos de soia, 1 lingură zeamă de lime, 1 linguriță ienibahar, 1 linguriță cimbru, 1/2 linguriță scorțișoară, 1/2 linguriță nucșoară, 1 linguriță zahăr brun",
                "150g orez",
                "120g fasole roșie din conservă, scursă",
                "100ml lapte de cocos light plus 150ml apă",
            ],
        },
        "instructions": {
            "en": [
                "Blend all the marinade ingredients into a dark, thick paste; coat the chicken and marinate at least 20 minutes, ideally overnight.",
                "Cook the rice with the beans, coconut milk and water until tender and the liquid is absorbed.",
                "Grill or pan-roast the chicken over medium-high heat, turning, for 15-18 minutes until charred and cooked through.",
                "Slice the chicken and serve over the coconut rice and beans, with lime wedges.",
            ],
            "ro": [
                "Blenduiește toate ingredientele pentru marinată într-o pastă închisă și groasă; acoperă puiul și lasă-l la marinat cel puțin 20 de minute, ideal peste noapte.",
                "Fierbe orezul cu fasolea, laptele de cocos și apa până e fraged și lichidul e absorbit.",
                "Frige puiul pe grătar sau în tigaie la foc mediu-mare, întorcând, 15-18 minute până e rumenit și pătruns.",
                "Feliază puiul și servește-l peste orezul cu cocos și fasole, cu felii de lime.",
            ],
        },
    },
    {
        "id": "global-thai-beef-larb",
        "icon": "salad",
        "name": {"en": "Thai beef larb", "ro": "Larb thailandez cu vită"},
        "tagline": {
            "en": "Hot, sour, herb-loud minced beef with a toasted-rice crunch — a 15-minute salad that hits like a main.",
            "ro": "Vită tocată iute, acrișoară și plină de verdeață, cu crocant de orez prăjit — o salată de 15 minute care lovește ca un fel principal.",
        },
        "tags": ["high-protein", "quick", "low-calorie", "cut"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Lap%20mu%20isan.JPG",
        "prep_minutes": 15,
        "servings": 2,
        "weight_g": 260,
        "calories": 310,
        ...
        "ingredients": {
            "en": [
                ...
                "Large handful of mint and cilantro leaves",
                "1/2 tsp chili flakes, or to taste",
                "Lettuce leaves and cucumber, to serve",
            ],
            "ro": [
                "350g carne tocată slabă de vită",
                "1 lingură orez crud, prăjit și măcinat",
                "2 linguri zeamă de lime",
                "1 lingură sos de pește",
                "2 cepe eșalotă, feliate subțire",
                "3 fire de ceapă verde, feliate",
                "Un pumn mare de frunze de mentă și coriandru",
                "1/2 linguriță fulgi de chili, sau după gust",
                "Frunze de salată și castravete, la servire",
            ],
        },
        "instructions": {
            "en": [
                "Toast the rice in a dry pan over medium heat until deep golden and fragrant, then grind to a coarse powder.",
                "Cook the beef in the same pan over high heat, breaking it up, until just done and any liquid has evaporated; take off the heat.",
                "Stir in the lime juice, fish sauce, shallots, spring onions, chili and ground rice while still warm.",
                "Fold the herbs through at the last moment and serve with lettuce and cucumber to wrap or scoop.",
            ],
            "ro": [
                "Prăjește orezul într-o tigaie uscată la foc mediu până devine auriu-închis și aromat, apoi macină-l grosier.",
                "Gătește vita în aceeași tigaie la foc mare, mărunțind-o, până e făcută și lichidul s-a evaporat; ia de pe foc.",
                "Amestecă, cât e caldă, zeama de lime, sosul de pește, eșalota, ceapa verde, chili și orezul măcinat.",
                "Adaugă verdețurile în ultimul moment și servește cu salată și castravete, ca să rulezi sau să iei cu ele.",
            ],
        },
    },
    {
        ...
        "tagline": {
            "en": "Blackened-spice loud, almost carb-free — a cut dinner that never once feels like less.",
            "ro": "Zgomotos de la condimentele Cajun, aproape fără carbohidrați — o cină de definire care nu pare niciodată „mai puțin”.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "A steakhouse plate in bowl form, for the days the surplus genuinely calls for it.",
            "ro": "O farfurie de steakhouse în formă de bol, pentru zilele în care surplusul chiar o cere.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "All the sizzle of fajitas, none of the tortilla tax — charred steak, blistered peppers, over rice.",
            "ro": "Tot sfârâitul de fajita, fără taxa de tortilla — vită rumenită, ardei pârliți, peste orez.",
        },
    ...
    },
    {
        "id": "global-shakshuka",
        "icon": "stew",
        "name": {"en": "Shakshuka with feta & spinach", "ro": "Shakshuka cu feta și spanac"},
        "tagline": {
            "en": "Eggs poached straight into a spiced tomato pan, feta softening at the edges — a skillet you carry to the table.",
            "ro": "Ouă poșate direct într-o tigaie de roșii condimentate, cu feta înmuindu-se pe margini — o tigaie pe care o duci direct la masă.",
        },
        "tags": ["high-protein", "vegetarian", "quick", "breakfast", "low-calorie", "cut", "maintain"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Shakshuka%20by%20Calliopejen1.jpg",
        "prep_minutes": 25,
        "servings": 2,
        "weight_g": 380,
        "calories": 340,
        ...
        "ingredients": {
            "en": [
                ...
                "2 cloves garlic, minced",
                "1 tsp smoked paprika, 1 tsp cumin, pinch of chili flakes",
                "80g feta, crumbled",
                "60g baby spinach",
            ...
            "ro": [
                "4 ouă",
                "400g roșii cuburi din conservă",
                "1 ceapă, tăiată cubulețe",
                "1 ardei gras roșu, tăiat cubulețe",
                "2 căței de usturoi, tocați",
                "1 linguriță boia afumată, 1 linguriță chimen, un vârf de fulgi de chili",
                "80g feta, sfărâmată",
                "60g spanac tânăr",
                "Pătrunjel sau coriandru proaspăt, pentru finisare",
            ],
        },
        "instructions": {
            "en": [
                "Soften the onion and pepper in a little oil over medium heat for 6-8 minutes, then add the garlic and spices and cook 1 minute more.",
                "Pour in the tomatoes, season, and simmer 8-10 minutes until thickened; stir the spinach through until wilted.",
                "Make four wells in the sauce, crack an egg into each, scatter over the feta, cover, and cook 5-7 minutes until the whites set but the yolks still run.",
                "Finish with parsley or cilantro and serve straight from the pan, with bread alongside.",
            ],
            "ro": [
                "Înmoaie ceapa și ardeiul în puțin ulei la foc mediu 6-8 minute, apoi adaugă usturoiul și mirodeniile și mai gătește 1 minut.",
                "Toarnă roșiile, condimentează și fierbe 8-10 minute până se îngroașă; încorporează spanacul până se ofilește.",
                "Fă patru cuiburi în sos, sparge câte un ou în fiecare, presară feta, acoperă și gătește 5-7 minute până albușul se leagă, dar gălbenușul rămâne curgător.",
                "Finalizează cu pătrunjel sau coriandru și servește direct din tigaie, cu pâine alături.",
            ],
        },
    },
    {
        "id": "global-huevos-rancheros",
        "icon": "omelette",
        "name": {"en": "Huevos rancheros", "ro": "Huevos rancheros"},
        "tagline": {
            "en": "Fried eggs over warm tortillas and a smoky ranchero sauce with black beans — a loud, colorful start at 29g protein.",
            "ro": "Ouă ochiuri peste tortilla caldă și un sos ranchero afumat cu fasole neagră — un început gălăgios și colorat, cu 29 g de proteină.",
        },
        "tags": ["high-protein", "vegetarian", "quick", "breakfast", "maintain"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Huevos%20Rancheros%20(11494813583).jpg",
        "prep_minutes": 15,
        "servings": 1,
        "weight_g": 340,
        "calories": 470,
        ...
        "ingredients": {
            "en": [
                ...
                "120g canned black beans, warmed",
                "150g tomato salsa, or crushed tomatoes with 1/2 tsp smoked paprika and a pinch of chili",
                "30g cheese, grated",
                "1/4 avocado, sliced; fresh cilantro; lime",
            ],
            "ro": [
                "2 ouă",
                "2 tortilla mici de porumb",
                "120g fasole neagră din conservă, încălzită",
                "150g salsa de roșii, sau roșii pasate cu 1/2 linguriță boia afumată și un vârf de chili",
                "30g brânză, rasă",
                "1/4 avocado, feliat; coriandru proaspăt; lime",
            ],
        },
        "instructions": {
            "en": [
                "Warm the salsa or spiced tomatoes in a small pan and keep it hot.",
                "Char the tortillas briefly in a dry pan, then top each with black beans.",
                "Fry the eggs to your liking and set them over the beans.",
                "Spoon the ranchero sauce around, scatter over the cheese, and finish with avocado, cilantro and a squeeze of lime.",
            ],
            "ro": [
                "Încălzește salsa sau roșiile condimentate într-o crăticioară și ține fierbinte.",
                "Rumenește scurt tortillele într-o tigaie uscată, apoi pune pe fiecare fasole neagră.",
                "Fă ouăle ochiuri după preferință și așază-le peste fasole.",
                "Toarnă sosul ranchero în jur, presară brânza și finalizează cu avocado, coriandru și puțină zeamă de lime.",
            ],
        },
    },
    {
        ...
        "tagline": {
            "en": "Charred stone fruit and torn mozzarella make 26 grams of lean protein feel like a menu special.",
            "ro": "Fruct rumenit pe grătar și mozzarella ruptă în mână fac din 26 g de proteină slabă un preparat de meniu de sezon.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "The meal-prep bowl that started it all — grilled chicken, fluffy quinoa, bright-green broccoli, one lid.",
            "ro": "Bolul de meal-prep de la care a pornit totul — pui la grătar, quinoa pufoasă, broccoli verde-crud, un singur capac.",
        },
        "tags": ["high-protein", "quick", "meal-prep", "cut"],
    ...
    },
    {
        ...
        "icon": "bowl",
        "name": {"en": "Honey-garlic chicken & charred sweet potato tray", "ro": "Tavă cu pui glazurat cu miere și usturoi și cartof dulce caramelizat"},
        "tagline": {
            "en": "One tray, one wash-up, a week of lunches — honey-garlic chicken against charred sweet potato.",
            "ro": "O tavă, un vas de spălat, o săptămână de prânzuri — pui cu miere și usturoi lângă cartof dulce caramelizat.",
        },
        "tags": ["high-protein", "meal-prep", "bulk"],
    ...
    },
    {
        ...
        "icon": "bowl",
        "name": {"en": "Sesame-ginger beef & broccoli rice bowl", "ro": "Bol cu vită, broccoli și orez, cu susan și ghimbir"},
        "tagline": {
            "en": "Glossy, sesame-slicked beef and broccoli over rice — takeout you can actually put macros on.",
            "ro": "Vită și broccoli lucioase de la susan, peste orez — mâncare la pachet pe care chiar poți pune macronutrienți.",
        },
        "tags": ["high-protein", "meal-prep", "bulk"],
    ...
    },
    {
        ...
        "tagline": {
            "en": "One tray, three components, restaurant plating — omega-3 salmon against caramelized sweet potato.",
            "ro": "O tavă, trei componente, prezentare de restaurant — somon bogat în omega-3 lângă cartof dulce caramelizat.",
        },
        "tags": ["high-protein", "balanced", "bulk"],
    ...
    },
    {
        ...
        "icon": "fish",
        "name": {"en": "Lemon-herb baked cod with quinoa & green beans", "ro": "Cod la cuptor cu lămâie și ierburi, quinoa și fasole verde"},
        "tagline": {
            "en": "Flaky, herb-bright cod over quinoa — a lean plate that still reads like a restaurant order.",
            "ro": "Cod fraged, luminos de la ierburi, peste quinoa — o farfurie slabă care arată totuși a comandă la restaurant.",
        },
        "tags": ["high-protein", "low-calorie", "cut"],
    ...
    },
    {
        ...
        "tagline": {
            "en": "A fast, loud wok toss that turns lean turkey into something you actually look forward to.",
            "ro": "Un salt rapid și zgomotos la wok care transformă curcanul slab în ceva ce chiar aștepți cu nerăbdare.",
        },
    ...
    },
    {
        ...
        "icon": "pasta",
        "name": {"en": "Italian herb turkey meatballs with zucchini noodles", "ro": "Chiftele de curcan cu ierburi italiene și tăiței de dovlecel"},
        "tagline": {
            "en": "Spaghetti-and-meatballs comfort at a third of the carbs — herby turkey over zucchini ribbons.",
            "ro": "Confortul de spaghete cu chiftele la o treime din carbohidrați — curcan cu ierburi peste panglici de dovlecel.",
        },
        "tags": ["high-protein", "low-calorie", "cut"],
    ...
    },
    {
        ...
        "tagline": {
            "en": "Coconut-rich, warmly spiced, quietly hitting 12 grams of fiber — proof plant-based isn't a compromise.",
            "ro": "Cremos de la cocos, cald condimentat, cu 12 grame de fibre pe tăcute — dovada că „vegetal” nu înseamnă compromis.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Plump shrimp, ripe avocado, a hard squeeze of lime — lean protein that still feels like an indulgence.",
            "ro": "Creveți cărnoși, avocado copt, o stoarcere zdravănă de lime — proteină slabă care pare totuși un moft.",
        },
        "tags": ["high-protein", "quick", "low-calorie", "cut"],
    ...
    },
    {
        ...
        "icon": "salad",
        "name": {"en": "Mediterranean tuna & chickpea salad", "ro": "Salată mediteraneeană cu ton și năut"},
        "tagline": {
            "en": "Lemon-sharp, ten minutes, no cooking — two pantry cans turned into 30 grams of protein.",
            "ro": "Cu accent de lămâie, zece minute, fără gătit — două conserve din cămară devenite 30 de grame de proteină.",
        },
        "tags": ["high-protein", "quick", "low-calorie", "cut"],
        "image_url": "https://commons.wikimedia.org/wiki/Special:FilePath/Colorful%20healthy%20Chickpea%20Salad%20-%2049859083608.jpg",
        "prep_minutes": 10,
        "servings": 1,
        "weight_g": 320,
        "calories": 350,
    ...
    },
    {
        ...
        "tagline": {
            "en": "Cold, make-ahead, endlessly packable — pantry tuna turned into a lunch you don't dread.",
            "ro": "Rece, pregătită din timp, ușor de dus oriunde — ton din cămară transformat într-un prânz pe care nu-l eviți.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Thin, blistered, three toppings only — proof a surplus day can still be elegant.",
            "ro": "Subțire, cu bule, doar trei toppinguri — dovada că o zi de surplus poate fi totuși elegantă.",
        },
        ...
        "ingredients": {
            "en": [
                "2 flatbreads or thin pizza bases",
                "100g tomato sauce",
            ...
            "ro": [
                "2 lipii sau blaturi subțiri de pizza",
                "100g sos de roșii",
                "150g mozzarella proaspătă, feliată",
    ...
    },
    {
        ...
        "icon": "sandwich",
        "name": {"en": "Loaded egg, bean & avocado breakfast burrito", "ro": "Burrito de mic dejun cu ouă, fasole și avocado"},
        "tagline": {
            "en": "A real mass-gainer you can hold in one hand — eggs, beans, cheese and avocado, all wrapped.",
            "ro": "Un adevărat „mass-gainer” pe care îl ții într-o mână — ouă, fasole, brânză și avocado, totul rulat.",
        },
        "tags": ["high-protein", "breakfast", "bulk"],
    ...
    },
    {
        ...
        "icon": "oats",
        "name": {"en": "Dark chocolate peanut butter protein overnight oats", "ro": "Ovăz peste noapte cu ciocolată neagră, unt de arahide și proteină"},
        "tagline": {
            "en": "Dark chocolate and peanut butter, set overnight — a jar that tastes like cheating and logs like breakfast.",
            "ro": "Ciocolată neagră și unt de arahide, lăsate peste noapte — un borcan cu gust de păcat și profil de mic dejun.",
        },
    ...
    },
    {
        ...
        "icon": "oats",
        "name": {"en": "Cinnamon banana protein oatmeal bowl", "ro": "Bol de terci de ovăz cu proteină, banană și scorțișoară"},
        "tagline": {
            "en": "Warm, cinnamon-laced, 32 grams of protein — the morning target hit on autopilot.",
            "ro": "Cald, cu scorțișoară, 32 de grame de proteină — ținta de dimineață atinsă pe pilot automat.",
        },
        "tags": ["high-protein", "breakfast", "meal-prep", "bulk"],
    ...
    },
    {
        ...
        "icon": "oats",
        "name": {"en": "Banana protein pancake stack with almond butter drizzle", "ro": "Teanc de clătite proteice cu banană și sos de unt de migdale"},
        "tagline": {
            "en": "A stack that photographs like a cheat meal and logs like a Tuesday breakfast.",
            "ro": "Un teanc care arată în poze ca o masă de răsfăț și se încadrează ca un mic dejun de marți.",
        },
        "tags": ["high-protein", "breakfast", "quick", "maintain"],
    ...
    },
    {
        ...
        "icon": "omelette",
        "name": {"en": "Truffle parmesan egg white scramble", "ro": "Ouă jumări din albuș cu trufe și parmezan"},
        "tagline": {
            "en": "A few drops of truffle oil, and plain egg whites turn into something you'd order out.",
            "ro": "Câteva picături de ulei de trufe și albușurile simple devin ceva ce ai comanda la restaurant.",
        },
    ...
    },
    {
        ...
        "tagline": {
            "en": "Layered like dessert, built like a shake — 24 grams of protein before you've fully woken up.",
            "ro": "Aranjat ca un desert, construit ca un shake — 24 de grame de proteină înainte să te trezești de-a binelea.",
        },
        ...
        "ingredients": {
            ...
            "ro": [
                "250g iaurt grecesc simplu",
                "100g fructe de pădure, mix",
                "25g granola",
        ...
        "instructions": {
            ...
            "ro": [
                "Așază în straturi iaurtul, fructele de pădure și granola într-un pahar.",
                "Stropește cu miere, dacă folosești.",
            ],
        },
    },
    {
        ...
        "icon": "parfait",
        "name": {"en": "Cottage cheese berry parfait with toasted almonds", "ro": "Parfait cu brânză de vaci, fructe de pădure și migdale prăjite"},
        "tagline": {
            "en": "Five minutes, 24 grams of protein, toasted almonds for crunch — the snack that eats like dessert.",
            "ro": "Cinci minute, 24 de grame de proteină, migdale prăjite pentru crocant — gustarea cu gust de desert.",
        },
        "tags": ["high-protein", "quick", "breakfast", "vegetarian", "cut"],
    ...
    },
    {
        ...
        "tagline": {
            "en": "A sunrise-colored bowl thick enough for a spoon — turmeric, mango, 30 grams of protein.",
            "ro": "Un bol de culoarea răsăritului, gros cât să-l mănânci cu lingura — turmeric, mango, 30 de grame de proteină.",
        },
    ...
    },
    {
        ...
        "icon": "dessert",
        "name": {"en": "Dark chocolate peanut butter protein bites", "ro": "Bilute proteice cu ciocolată neagră și unt de arahide"},
        "tagline": {
            "en": "No oven, five minutes, waiting in the fridge — for the exact moment a cut starts arguing back.",
            "ro": "Fără cuptor, cinci minute, gata la frigider — exact pentru momentul în care definirea începe să protesteze.",
        },
        "tags": ["high-protein", "quick", "vegetarian", "maintain"],
